...
package MyApp::GUI::Frame::Notepad::StatusBar {
    ...
    has 'gauge' => (
        is          => 'rw', 
        isa         => 'MyApp::GUI::Frame::Notepad::StatusBar::Gauge',
        lazy_build  => 1,
    );
    has 'gauge_field' => (
        is          => 'rw', 
    ...
    sub _build_gauge {#{{{
        ...
        my $g = MyApp::GUI::Frame::Notepad::StatusBar::Gauge->new(
            parent      => $self,
            position    => $pos,
            size        => $size,
        );
...
MyApp::GUI::Frame::Notepad::StatusBar - Status bar displayed at the bottom of the 
main frame.
...
Assuming $self is a Wx::Frame onto which you want to add a status bar:
 ...
 $status_bar = MyApp::GUI::Frame::Notepad::StatusBar->new(
